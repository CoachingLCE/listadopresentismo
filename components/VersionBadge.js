  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-3 right-4 text-[11px] text-textMuted bg-surface2/80 border border-border rounded-full px-3 py-1 z-40 hover:text-text hover:border-accentTeal transition-colors"
        title="Ver novedades"
      >
