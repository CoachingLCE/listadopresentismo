...
export {
  tienePermisoVer,
  esSuperAdmin,
  tienePermisoGestionAcademica,
  tienePermisoGestionRosterDocentes,
  tienePermisoCargarAsistencia,
  tienePermisoEscribirNotasEstudiante,
  tienePermisoVerHistorial,
  tienePermisoAccesos,
  tienePermisoGestionarAdmins,
  esRolLimitadoAEdicionesPropias
} from './permisos';
