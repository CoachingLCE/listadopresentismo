...
export const CHANGELOG = [
  {
    ...
    fecha: '2026-09-25',
    cambios: [
      'Nueva edición: las fechas de inicio/finalización y el calendario ahora se muestran en formato DD/MM/AAAA en vez de AAAA-MM-DD.',
      'Nueva edición: el texto de la vista previa ahora aclara que el receso entre cuatrimestres es de dos semanas.',
      'Emails: la pantalla se agrandó y la tabla de "Mails automáticos" y el "Registro de envíos" ahora tienen el mismo formato que en las otras apps de ILCE (columna "De", y "Ver mail" abre una ventana en vez de desplegarse dentro de la fila).'
    ]
  },
  {
    version: '0.3.11',
    fecha: '2026-09-25',
    cambios: [
      'Accesos: al guardar un rol ahora se ve enseguida si se guardó bien o si falló (antes, si el guardado fallaba, el radio se quedaba mostrando el rol nuevo igual, y recién al recargar la página se veía que en realidad no se había guardado).',
      'Ficha de edición: el bloque "Seguimiento de Asistencia" (tarjetas + gráficos) ahora aparece debajo de "Listado de presentismo" en vez de arriba.',
      'Listado de presentismo: la columna "Estado" ahora queda fija junto a "Estudiante" al desplazarse hacia la derecha, igual que ya pasaba con el nombre.',
      'Corregido: marcar una clase puntual como "Asincrónico" (o "Baja") recargaba toda la pantalla de golpe (se veía el esqueleto de carga completo), lo que daba la sensación de que el cambio no se guardaba o se perdía el scroll — ahora se actualiza en el momento, sin recargar todo.'
    ]
  },
  {
    version: '0.3.10',
